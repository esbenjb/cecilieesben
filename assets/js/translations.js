...
window.TRANSLATIONS = {
  da: {
    ...
    'hero.dateline': 'Bryllup · 12. juni 2027',
    ...
    'travel.reykjavik.country': 'Island',
    'travel.helsinki.place': 'Helsinki',
    'travel.helsinki.country': 'Finland',
    'travel.helsinki.alt':
      'Cecilie og Esben ved foden af kæmpeskulpturen Bad Bad Boy på havnefronten i Helsinki',
    'travel.stockholm.place': 'Stockholm',
    'travel.stockholm.country': 'Sverige',
    'travel.stockholm.alt':
      'Cecilie og Esben på Djurgårdsbron med Stockholms havneløb bag sig',
    'travel.riga.country': 'Letland',
    'travel.bennevis.place': 'Ben Nevis',
    'travel.bennevis.country': 'Skotland',
    'travel.bennevis.alt':
      'Cecilie og Esben ved stenvarden på toppen af Ben Nevis',
    'travel.edinburgh.place': 'Edinburgh',
    'travel.edinburgh.alt':
      'Cecilie og Esben over de brogede facader på Victoria Street i Edinburgh',
    'travel.heidelberg.place': 'Heidelberg',
    'travel.heidelberg.country': 'Tyskland',
    'travel.heidelberg.alt':
      'Cecilie og Esben på terrassen over Heidelberg med slotsruinen bag sig',
    'travel.paris.place': 'Paris',
    'travel.paris.country': 'Frankrig',
    'travel.paris.alt':
      'Cecilie og Esben på en altan med Triumfbuen og Champs-Élysées bag sig',
    'travel.munchen.place': 'München',
    'travel.munchen.country': 'Tyskland',
    'travel.munchen.alt':
      'Cecilie og Esben med hver sin hvedeøl ved langbordet i en münchnersk biergarten',
    ...
    'travel.carcassonne.place': 'Carcassonne',
    'travel.carcassonne.country': 'Frankrig',
    'travel.carcassonne.alt':
      'Cecilie og Esben foran porten til den middelalderlige fæstningsby Carcassonne',
    'travel.kazbek.place': 'Kazbek',
    'travel.kazbek.country': 'Georgien',
    'travel.kazbek.alt':
      'Cecilie og Esben på stien med det snedækkede Kazbek bag sig',
    'travel.mosmieri.place': 'Kakheti',
    'travel.mosmieri.country': 'Georgien',
    'travel.mosmieri.alt':
      'Cecilie og Esben skåler ved et langbord med udsigt over vinmarkerne i Kakheti',
    'travel.gallipoli.country': 'Italien',
    'travel.soller.place': 'Port de Sóller',
    'travel.soller.country': 'Spanien',
    'travel.soller.alt':
      'Cecilie og Esben med paella på stranden i Port de Sóller, mens solen går ned over havnen',
    'travel.crete.place': 'Kreta',
    'travel.crete.country': 'Grækenland',
    'travel.crete.alt':
      'Cecilie og Esben klædt ud som hummer og Poseidon',
    'travel.metsada.place': 'Masada',
    'travel.metsada.country': 'Israel',
    'travel.metsada.alt':
      'Cecilie og Esben ved fæstningsmuren på Masada med Det Døde Hav langt nedenfor',
    'travel.giza.place': 'Giza',
    'travel.giza.alt':
      'Cecilie og Esben ved frokostbordet med pyramiderne i Giza i baggrunden',
    'travel.luxor.place': 'Luxor',
    'travel.luxor.country': 'Egypten',
    'travel.luxor.alt':
      'Cecilie og Esben i en båd på Nilen ved Luxor',
    'travel.uganda.place': 'Murchison Falls',
    'travel.uganda.alt':
      'Cecilie og Esben på savannen med giraffer i baggrunden',
    'travel.bwindi.place': 'Bwindi',
    ...
    'travel.seoul.alt':
      'Cecilie og Esben på en udsigtsplatform over Seoul en klar efterårsdag',
    'travel.thailand.country': 'Thailand',
    'travel.raleigh.place': 'Raleigh',
    'travel.raleigh.country': 'USA',
    'travel.raleigh.alt':
      'Cecilie og Esben på verandatrappen med morgenkaffen',
    ...
    'travel.quilotoa.place': 'Quilotoa',
    'travel.quilotoa.alt':
      'Cecilie og Esben på kraterkanten over den grønne kratersø Quilotoa',
    'travel.amazonas.country': 'Brasilien',
    'travel.uyuni.place': 'Salar de Uyuni',
    'travel.uyuni.alt':
      'Cecilie lader som om hun holder en lille Esben i hånden på den spejlblanke saltslette Salar de Uyuni',
    'travel.brasilien.country': 'Brasilien',
    'travel.sambadromen.place': 'Sambadromen',
    'travel.sambadromen.country': 'Brasilien',
    'travel.sambadromen.alt':
      'Cecilie og Esben til karneval på Sambadromen i Rio',
    'travel.iguazu.place': 'Iguazú',
    'travel.iguazu.alt':
      'Cecilie og Esben foran de brede vandfald ved Iguazú',
    'travel.petrohue.country': 'Chile',
    ...
    'travel.silkeborg.place': 'Silkeborg',
    'travel.silkeborg.country': 'Danmark',
    'travel.silkeborg.alt':
      'Cecilie på Esbens skuldre blandt Silkeborg-fans i rødt',
    'travel.island.country': 'Island',
    'travel.reykjavik.place': 'Reykjavík',
    'travel.reykjavik.alt':
      'Cecilie og Esben kind mod kind, mens Cecilie viser forlovelsesringen frem',
    'travel.edinburgh.country': 'Skotland',
    'travel.riga.place': 'Riga',
    'travel.riga.alt':
      'Cecilie og Esben ved et cafébord med udsigt til jugendstilsfacaderne i Riga',
    ...
    'travel.gallipoli.place': 'Gallipoli',
    'travel.gallipoli.alt':
      'Cecilie og Esben ved havnemuren i Gallipoli, mens solen går ned over Middelhavet',
    'travel.giza.country': 'Egypten',
    ...
    'travel.quilotoa.country': 'Ecuador',
    'travel.amazonas.place': 'Amazonfloden',
    'travel.amazonas.alt':
      'Cecilie og Esben i en træbåd på Amazonfloden i morgenlyset',
    'travel.uyuni.country': 'Bolivia',
    'travel.brasilien.place': 'Rio de Janeiro',
    'travel.brasilien.alt':
      'Cecilie og Esben foran et vægmaleri med ordet Brasil',
    'travel.iguazu.country': 'Argentina',
    'travel.petrohue.place': 'Petrohué',
    'travel.petrohue.alt':
      'Cecilie og Esben ved Petrohué-vandfaldene med vulkanen Osorno i baggrunden',
    ...
    'around.eyebrow': 'Området omkring Silkeborg',
    ...
    'practical.6.contact': 'info@cecilieesben.com',
    ...
    'gifts.note': 'Ønskesedlen er på vej. Vi lægger den op i god tid inden brylluppet.',
  ...
  en: {
    ...
    'hero.dateline': 'Wedding · 12 June 2027',
    ...
    'venue.title': 'Gl. Skovridergaard',
    'venue.teaser':
      'A former forester’s estate from 1798 in the middle of Søhøjlandet, with its own park, the forest next door and Lake Almindsø a short walk away.',
    'venue.cta': 'See the venue',

    'venuepage.eyebrow': 'The venue',
    'venuepage.title': 'Gl. Skovridergaard',
    'venuepage.lead':
      'The whole wedding weekend takes place at Gl. Skovridergaard just outside Silkeborg. The estate dates back to 1798 and sits in the heart of Søhøjlandet, with its own park, the Silkeborg forests next door and Lake Almindsø within walking distance. Today it is a hotel and conference centre, so every guest can sleep in the same place we celebrate.',
    ...
    'travel.reykjavik.country': 'Iceland',
    'travel.helsinki.place': 'Helsinki',
    'travel.helsinki.country': 'Finland',
    'travel.helsinki.alt':
      'Cecilie and Esben at the foot of the giant Bad Bad Boy sculpture on the Helsinki waterfront',
    'travel.stockholm.place': 'Stockholm',
    'travel.stockholm.country': 'Sweden',
    'travel.stockholm.alt':
      'Cecilie and Esben on Djurgårdsbron with the Stockholm waterfront behind them',
    'travel.riga.country': 'Latvia',
    'travel.bennevis.place': 'Ben Nevis',
    'travel.bennevis.country': 'Scotland',
    'travel.bennevis.alt':
      'Cecilie and Esben by the summit cairn on top of Ben Nevis',
    'travel.edinburgh.place': 'Edinburgh',
    'travel.edinburgh.alt':
      'Cecilie and Esben above the brightly painted shopfronts of Victoria Street in Edinburgh',
    'travel.heidelberg.place': 'Heidelberg',
    'travel.heidelberg.country': 'Germany',
    'travel.heidelberg.alt':
      'Cecilie and Esben on the terrace above Heidelberg with the castle ruins behind them',
    'travel.paris.place': 'Paris',
    'travel.paris.country': 'France',
    'travel.paris.alt':
      'Cecilie and Esben on a balcony with the Arc de Triomphe and the Champs-Élysées behind them',
    'travel.munchen.place': 'Munich',
    'travel.munchen.country': 'Germany',
    'travel.munchen.alt':
      'Cecilie and Esben with a wheat beer each at a long table in a Munich beer garden',
    'travel.budapest.place': 'Budapest',
    'travel.budapest.alt':
    ...
    'travel.carcassonne.place': 'Carcassonne',
    'travel.carcassonne.country': 'France',
    'travel.carcassonne.alt':
      'Cecilie and Esben in front of the gate to the medieval walled city of Carcassonne',
    'travel.kazbek.place': 'Kazbek',
    'travel.kazbek.country': 'Georgia',
    'travel.kazbek.alt':
      'Cecilie and Esben on the path with snow-covered Mount Kazbek behind them',
    'travel.mosmieri.place': 'Kakheti',
    'travel.mosmieri.country': 'Georgia',
    'travel.mosmieri.alt':
      'Cecilie and Esben raising a glass at a long table overlooking the vineyards of Kakheti',
    'travel.gallipoli.country': 'Italy',
    'travel.soller.place': 'Port de Sóller',
    'travel.soller.country': 'Spain',
    'travel.soller.alt':
      'Cecilie and Esben with paella on the beach at Port de Sóller as the sun sets over the harbour',
    'travel.crete.place': 'Crete',
    'travel.crete.country': 'Greece',
    'travel.crete.alt':
      'Cecilie and Esben in fancy dress as a lobster and Poseidon',
    'travel.metsada.place': 'Masada',
    'travel.metsada.country': 'Israel',
    'travel.metsada.alt':
      'Cecilie and Esben by the fortress wall at Masada with the Dead Sea far below',
    'travel.giza.place': 'Giza',
    'travel.giza.alt':
      'Cecilie and Esben at a lunch table with the pyramids of Giza behind them',
    'travel.luxor.place': 'Luxor',
    'travel.luxor.country': 'Egypt',
    'travel.luxor.alt':
      'Cecilie and Esben in a boat on the Nile at Luxor',
    'travel.uganda.place': 'Murchison Falls',
    'travel.uganda.alt':
    ...
    'travel.seoul.alt':
      'Cecilie and Esben on a viewing platform above Seoul on a clear autumn day',
    'travel.thailand.country': 'Thailand',
    'travel.raleigh.place': 'Raleigh',
    'travel.raleigh.country': 'USA',
    'travel.raleigh.alt':
      'Cecilie and Esben on the porch steps with their morning coffee',
    'travel.teotihuacan.place': 'Teotihuacán',
    'travel.teotihuacan.alt':
    ...
    'travel.quilotoa.place': 'Quilotoa',
    'travel.quilotoa.alt':
      'Cecilie and Esben on the crater rim above the green crater lake of Quilotoa',
    'travel.amazonas.country': 'Brazil',
    'travel.uyuni.place': 'Salar de Uyuni',
    'travel.uyuni.alt':
      'Cecilie pretending to hold a tiny Esben in her hand on the mirror-like salt flat of Salar de Uyuni',
    'travel.brasilien.country': 'Brazil',
    'travel.sambadromen.place': 'The Sambadrome',
    'travel.sambadromen.country': 'Brazil',
    'travel.sambadromen.alt':
      'Cecilie and Esben at the carnival in the Rio Sambadrome',
    'travel.iguazu.place': 'Iguazú',
    'travel.iguazu.alt':
      'Cecilie and Esben in front of the wide waterfalls at Iguazú',
    'travel.petrohue.country': 'Chile',
    'travel.patagonien.place': 'El Chaltén',
    'travel.patagonien.alt':
    ...
    'travel.torres.country': 'Chile',
    'travel.silkeborg.place': 'Silkeborg',
    'travel.silkeborg.country': 'Denmark',
    'travel.silkeborg.alt':
      'Cecilie on Esben’s shoulders among Silkeborg supporters dressed in red',
    'travel.island.country': 'Iceland',
    'travel.reykjavik.place': 'Reykjavík',
    'travel.reykjavik.alt':
      'Cecilie and Esben cheek to cheek, with Cecilie holding up her engagement ring',
    'travel.edinburgh.country': 'Scotland',
    'travel.riga.place': 'Riga',
    'travel.riga.alt':
      'Cecilie and Esben at a café table looking out at the art nouveau façades of Riga',
    ...
    'travel.gallipoli.place': 'Gallipoli',
    'travel.gallipoli.alt':
      'Cecilie and Esben on the harbour wall in Gallipoli as the sun sets over the Mediterranean',
    'travel.giza.country': 'Egypt',
    'travel.zanzibar.place': 'Nungwi',
    'travel.zanzibar.alt':
    ...
    'travel.quilotoa.country': 'Ecuador',
    'travel.amazonas.place': 'The Amazon',
    'travel.amazonas.alt':
      'Cecilie and Esben in a wooden boat on the Amazon river in the morning light',
    'travel.uyuni.country': 'Bolivia',
    'travel.brasilien.place': 'Rio de Janeiro',
    'travel.brasilien.alt':
    ...
    'travel.petrohue.place': 'Petrohué',
    'travel.petrohue.alt':
      'Cecilie and Esben at the Petrohué waterfalls with the Osorno volcano behind them',
    'travel.patagonien.country': 'Argentina',
    'travel.torres.place': 'Torres del Paine',
    'travel.torres.alt':
